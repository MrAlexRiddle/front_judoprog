...
export function patchMode(setVarMode, personInfoEdit, setPersonInfo, settingsPerson, setTrainers, trainersEdit) {
        setVarMode({
    ...
    setTrainers(trainersEdit)
}

export function postMode(setVarMode) {
    setVarMode({
        button: 'Добавить пользователя', title: 'Форма добавления персоны в весовую категорию', style: {textAlign: 'center', marginBottom: '20px'}
    })
}